...
/*
Este ficheiro contém a resolução de todas as alineas do TPC 5
...
void WarshallTC(Graph A, Graph R, int n) {
    ...
    /*@ loop invariant  0 <= i <= n;
        ...
        loop invariant (\forall integer k, l; 0 <= k < i && 0 <= l < n ==> R[k][l] == A[k][l]);
    ...
    */
    for (i = 0; i < n; i++)
        /*@  
            ...
            loop invariant \valid(A+(0..(n*n-1)));
            loop invariant (\forall integer l; 0 <= l < j ==> R[i][l] == A[i][l]);
